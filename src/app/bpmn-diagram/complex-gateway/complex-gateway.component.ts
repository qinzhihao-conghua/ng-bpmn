...
@Component({
  selector: 'app-complex-gateway',
  templateUrl: './complex-gateway.component.html',
  styleUrls: ['./complex-gateway.component.scss']
})
export class ComplexGatewayComponent implements OnInit {
