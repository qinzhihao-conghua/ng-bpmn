...
@Component({
  selector: 'app-business-rule-task',
  templateUrl: './business-rule-task.component.html',
  styleUrls: ['./business-rule-task.component.scss']
})
export class BusinessRuleTaskComponent implements OnInit {
