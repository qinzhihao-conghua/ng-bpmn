...
@Component({
  selector: 'app-intermediate-throw-event',
  templateUrl: './intermediate-throw-event.component.html',
  styleUrls: ['./intermediate-throw-event.component.scss']
})
export class IntermediateThrowEventComponent implements OnInit {
