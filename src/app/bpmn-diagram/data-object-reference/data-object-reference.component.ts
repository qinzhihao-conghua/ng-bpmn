...
@Component({
  selector: 'app-data-object-reference',
  templateUrl: './data-object-reference.component.html',
  styleUrls: ['./data-object-reference.component.scss']
})
export class DataObjectReferenceComponent implements OnInit {
