...
@Component({
  selector: 'app-inclusive-gateway',
  templateUrl: './inclusive-gateway.component.html',
  styleUrls: ['./inclusive-gateway.component.scss']
})
export class InclusiveGatewayComponent implements OnInit {
